...
OPT_CONFIG_KWARGS = {
    ...
    'default': DEFAULT_CONFIG.get_default_user_config_path(),
    'metavar': 'PATH',
    'show_default': True,
...
OPT_LOG_FORMAT_KWARGS = {
    ...
    'default': DEFAULT_CONFIG.internal.default_log_format,
    'metavar': 'FORMAT',
    'show_default': True,
    'type': click.Choice(DEFAULT_CONFIG.internal.acceptable_log_formats)
}
